...
import com.azloganalytics.logback.LogbackAzLogAnalyticsAppender;
...
public class HTTPDataCollector {
	...
	private LogbackAzLogAnalyticsAppender appender;
	 ...
	 *            internal errors
	 */
	public HTTPDataCollector(String workspaceId, String sharedKey, int asyncThreadPoolSize, LogbackAzLogAnalyticsAppender appender,
			String proxyHost, Integer proxyPort) {
		this.appender = appender;
		if(executorService == null || executorService.isTerminated()){
			final ThreadFactory threadFactory = new AzLogThreadFactoryBuilder()
